...
#define    	RTU_R01_CMD               		0x01       	//读功能码01
#define    	RTU_R02_CMD               		0x02       	//读功能码02
#define    	RTU_R03_CMD               		0x03       	//读功能码03
#define    	RTU_R04_CMD               		0x04       	//读功能码04
#define    	RTU_W05_CMD               		0x05       	//读功能码05
...
#define    TXBUFF_LENGTH                	80         	//发送缓冲区长度  
...
#define    COM_BUFF_INSIDE_SHT21TEMP        12          //通信数据缓冲    腔内SHT21温度
#define    COM_BUFF_INSIDE_SHT21HUM         13          //通信数据缓冲    腔内SHT21湿度
#define    COM_BUFF_OUTSIDE_SHT21TEP		14			//通信数据缓冲    机柜SHT21温度
#define    COM_BUFF_OUTSIDE_SHT21HUM		15			//通信数据缓冲    机柜SHT21湿度
#define    COM_BUFF_CLEAN_PRESS   			16			//通信数据缓冲    洁净气压
#define    COM_BUFF_WORK_PRESS         		17			//通信数据缓冲    工作气压
#define    COM_BUFF_BACKUP_PRESS			18			//通信数据缓冲    备用气压
#define    COM_BUFF_TEMP_THRESHOLD			19			//通信数据缓冲    本检测板绕组温度阈值
...
#define    TXD_LENGTH                		65           //发送缓冲区长度  CurrMax=7 不含/n
