...
#define    RTU_REG_BASE              		0x1580     	//寄存器的通信基址
#define    RTU_ZONE_H                		0x15       	//RTU数据帧的数据区高地址
#define    RTU_DATA_H                		0x00       	//RTU数据帧的数据高字节

//-----------------------------------------------------------------------------------------------------------------------------------------
#define    MASTER_BASE_ADD             		0x30       	//主监测板地址
#define    LOCAL_BASE_ADD               	0x32       	//本监测板地址

#define    RXBUFF_LENGTH                	24         	//接收缓冲区长度  
#define    RXBUFF_MIN                   	8          //接收数据帧最小长度
#define    TXBUFF_LENGTH                	52         	//发送缓冲区长度  
#define    TXBUFF_MIN                   	11         	//发送数据帧最小长度

//------------------------------------------------------------------------------------------------------------------------------------
#define    COM_BUFF_LENGTH           		52        	//通信数据缓冲地址区长度    Max=14
